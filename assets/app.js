...
(function(){
  ...
  function ics(sess){
    ...
    var body = [
      "BEGIN:VCALENDAR","VERSION:2.0","PRODID:-//A2PRO//Padel//EN","BEGIN:VEVENT",
      "UID:"+sess.id+"@a2pro.cw",
      "DTSTAMP:"+stamp(new Date()),
      "DTSTART:"+stamp(sess.date),
      "DTEND:"+stamp(sess.end),
      "SUMMARY:"+sess.kind+" at A2PRO",
      "LOCATION:"+sess.court,
    ...
    a.href = url; a.download = "a2pro-" + sess.id + ".ics";
    a.click();
  ...
  document.addEventListener("click", function(e){
    ...
    if(sh){
      ...
      share("A2PRO", (r ? r.item + " · " : "") + c, codeUrl(c));
    }
  });
